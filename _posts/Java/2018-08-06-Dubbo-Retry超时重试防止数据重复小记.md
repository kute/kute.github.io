...
- <a href="#一、背景">一、背景</a>
- [二、方案][#schema]
  - [1、在配置了重试机制的基础上，修改 单个方法的  “重试” 的配置 + （调用方异常捕获 或者 配置降级策略）][#config_retry]
...
<h3 id="schema">二、方案</h3>

<h4 id="config_retry">1、在配置了重试机制的基础上，修改 单个方法的  “重试” 的配置 + （调用方异常捕获 或者 配置降级策略）</h4>
